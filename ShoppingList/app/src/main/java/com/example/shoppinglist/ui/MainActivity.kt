...
class MainActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        createItemTouchHelper().attachToRecyclerView(productList)
    ...
    private fun validateFields(): Boolean {
        return if (inputProduct.text.toString().isNotBlank() && inputQty.text.toString().isNotBlank()) {
            true
        } else {
    ...
    private fun addProduct() {
        if (validateFields()) {
            mainScope.launch {
                val product = Product(
                    name = inputProduct.text.toString(),
                    quantity = inputQty.text.toString().toInt()
                )
